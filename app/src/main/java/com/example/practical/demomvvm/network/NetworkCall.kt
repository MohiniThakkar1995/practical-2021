...
import NetworkCall.Companion.BASE_URL
...
import com.showaikh.driver.network.ApiInterface

import com.showaikh.driver.network.listeners.DefaultActionPerformer
import com.showaikh.driver.network.listeners.NoInternetListner
import com.showaikh.driver.network.listeners.RetrofitRawResponseListener
...
class NetworkCall constructor(context: Context) : Callback<ResponseBody> {
    ...
    companion object {
        ...
        private var BASE_URL = com.example.demomvvm.BuildConfig.BASE_URL // this will be affected by flavor in gradle
